  ...
  return (
    <group>
      ...
      >
        ...
        {/* <HelperArrow
        position={[0, 0, 0.8]}
        rotation={[0, (Math.PI * 9) / 16, Math.PI / 2]}
      /> */}
      </group>
      <HelperArrow
        position={[
          -Math.cos(((10 - 10) * (Math.PI * 2)) / 20 + (Math.PI * 2) / 20 / 2) *
            4,
          0,
          Math.sin(((10 - 10) * (Math.PI * 2)) / 20 + (Math.PI * 2) / 20 / 2) *
            4,
        ]}
