...
// Pass component mesh like Earth as child of Tile component
// Accept flag to enable click
// Pass flag to Tile component
// Reuse this component in other places
export default function Board({ device, position=[0,0,0], rotation=[0,0,0], scale=1, showStart=false, interactive=false }) {
