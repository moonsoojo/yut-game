        ...
        if (path.length > 0) {
            ...
            if (path[path.length-1] === 29) {
                ...
                api0_0.start({
                    from: {
                        position: [
                            roundNum(5 + idOffsets[0][0] * 2, 1),
                            roundNum(3 + heightOffset + idOffsets[0][1] * 2, 1),
                            roundNum(5 + idOffsets[0][2] * 2, 1),
                        ],
                        scale: 1
                    },
                    to: [
                        ...
                        {
                            position: [
                                roundNum(9 + idOffsets[0][0], 1),
                                roundNum(0 + heightOffset + idOffsets[0][1], 1),
                                roundNum(1.5 + idOffsets[0][2], 1),
                            ],
                            scale: 0,
                            config: {
                                tension: 100,
        ...
        if (path.length > 0) {
            ...
            if (path[path.length-1] === 29) {
                ...
                api0_1.start({
                    from: {
                        position: [
                            roundNum(5 + idOffsets[1][0] * 2, 1),
                            roundNum(3 + heightOffset + idOffsets[1][1] * 2, 1),
                            roundNum(5 + idOffsets[1][2] * 2, 1),
                        ],
                        scale: 1
                    },
                    to: [
                        ...
                        {
                            position: [
                                roundNum(9 + idOffsets[1][0], 1),
                                roundNum(0 + heightOffset + idOffsets[1][1], 1),
                                roundNum(1.5 + idOffsets[1][2], 1),
                            ],
                            scale: 0,
                            config: {
                                tension: 100,
        ...
        if (path.length > 0) {
            ...
            if (path[path.length-1] === 29) {
                ...
                api0_2.start({
                    from: {
                        position: [
                            roundNum(5 + idOffsets[2][0] * 2, 1),
                            roundNum(3 + heightOffset + idOffsets[2][1] * 2, 1),
                            roundNum(5 + idOffsets[2][2] * 2, 1),
                        ],
                        scale: 1
                    },
                    to: [
                        ...
                        {
                            position: [
                                roundNum(9 + idOffsets[2][0], 1),
                                roundNum(0 + heightOffset + idOffsets[2][1], 1),
                                roundNum(1.5 + idOffsets[2][2], 1),
                            ],
                            scale: 0,
                            config: {
                                tension: 100,
        ...
        if (path.length > 0) {
            ...
            if (path[path.length-1] === 29) {
                ...
                api0_3.start({
                    from: {
                        position: [
                            roundNum(5 + idOffsets[3][0] * 2, 1),
                            roundNum(3 + heightOffset + idOffsets[3][1] * 2, 1),
                            roundNum(5 + idOffsets[3][2] * 2, 1),
                        ],
                        scale: 1
                    },
                    to: [
                        ...
                        {
                            position: [
                                roundNum(9 + idOffsets[3][0], 1),
                                roundNum(0 + heightOffset + idOffsets[3][1], 1),
                                roundNum(1.5 + idOffsets[3][2], 1),
                            ],
                            scale: 0,
                            config: {
                                tension: 100,
